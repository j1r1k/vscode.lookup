...
| `Tab`         | Autocomplete forward     | Lookup prompt is open         |
| `Shift+Tab`   | Autocomplete backward    | Lookup prompt is open         |

## Configuration

| Setting              | Type       | Default      | Description                                              |
|----------------------|------------|--------------|----------------------------------------------------------|
| `lookup.separators`  | `string[]` | `[".", "/"]` | Characters treated as segment boundaries for autocomplete |
